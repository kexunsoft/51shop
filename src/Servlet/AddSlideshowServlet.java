...
@WebServlet("/AddSlideshow")
public class AddSlideshowServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9099875098517861655L;
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fileName="";
		 ...
		 Slideshow slideshow=new Slideshow(title,img,href);
		 boolean b = SlideshowDao.addSlideshow(slideshow);
		 if (b) {
