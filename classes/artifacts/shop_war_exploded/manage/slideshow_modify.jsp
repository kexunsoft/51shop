  ...
  <tr>
	...
	if(request.getParameter("id")==null){
		return;
			...
			Slideshow s=SlideshowDao.serichSlideshowByID(request.getParameter("id"));
	%>
       			 <form action="/shop/updateSlideshow" method="post" name="form1" enctype="multipart/form-data">
			    <table width="94%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolordark="#FFFFFF">
                  <tr>
                    ...
                    <input type="hidden" value="<%=s.getId()%>" name="id">
                      <input name="title" type="text" class="Sytle_text" id="bookID2" size="50" value="<%=s.getTitle()%>">&nbsp;&nbsp;  </td>
                  </tr>				
                   <tr>
                    <td width="14%" height="27">&nbsp;链接地址：</td>
                    <td height="27" colspan="3">&nbsp;
                      <input name="href" type="text" class="Sytle_text" id="bookID2" size="50" value="<%=s.getHref()%>">&nbsp;&nbsp;  </td>
                  </tr>	
                  <tr>
                    <td height="41">&nbsp;轮播图片：</td>
                    <td height="41">&nbsp;
                    		<img src="/shop/fromt/images/<%=s.getImg() %>" />
