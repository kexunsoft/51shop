  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="1089" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>修改新闻信息</b></td>
        <td width="10" background="images/manage_leftTitle_right.GIF">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table>
	<!---->
      			 <form action="../NewsModify" method="post" name="form1">
			    <table width="94%"  border="0" align="right" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td width="14%" height="27">&nbsp;新闻标题：
                      <input name="newsID" type="hidden" id="ID" value="<%=n.getEn_id()%>"></td>
                    <td height="27" colspan="3">&nbsp;
                      <input name="newsName" type="text" class="Sytle_text" value="<%=n.getEn_title() %>" size="50">
                      &nbsp;&nbsp;                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td colspan="3"><span class="style5">&nbsp; </span>
                        <textarea name="introduce" cols="60" rows="5" class="textarea" id="introduce" style="width:100%; height:400px; resize: none;"><%=n.getEn_content() %></textarea></td>
                  </tr>
                  <tr>
                    <td height="38" colspan="4" align="center">
                        <input name="Button" type="button" class="btn_bg_short" value="保存" onClick="mycheck()">
&nbsp;                        
<input  type="reset" class="btn_bg_short" value="重置">
                        &nbsp;
